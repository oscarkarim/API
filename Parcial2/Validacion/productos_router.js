...
router.post('/', [body('id_producto').notEmpty().withMessage('El campo id_producto es obligatorio').isInt().withMessage('El campo id_producto debe ser un número entero'),
  body('marca').notEmpty().withMessage('El campo marca es obligatorio'),
  body('modelo').notEmpty().withMessage('El campo modelo es obligatorio'),
  body('precio').notEmpty().withMessage('El campo precio es obligatorio').isInt().withMessage('El campo precio debe ser un número entero'),
  body('color').notEmpty().withMessage('El campo color es obligatorio'),
  body('categoria').notEmpty().withMessage('El campo categoria es obligatorio')
], (req, res) => {
